...
import time
### To Use standard out's 'write' function which will eliminate the default newlines created by 'print' function
import sys
...
board = []
# Remember all of the player's used moves (will be used to determined if a move is already taken and will ask player to select a different one)
player_all_moves = []


# Introduction and Player Names
### Receive sentence parameter and display it one letter at a time, flush standard out buffer, and display next letter. Wait .02 seconds before displaying next letter
...
delay_print("\n\n\t\t\tHello Players! Let's play a friendly game of Tic Tac Toe!\n\n\n")
...
def play_game():
	...
	while player1_move not in choices or player1_move in player_all_moves:
		if player1_move not in choices:
			player1_move = input(player1 + ", please make a valid move. For example: 'a1'  ").capitalize()
			print_board()
		elif player1_move in player_all_moves:
			player1_move = input(player1 + ", " + player1_move + " is already taken. Try somewhere else  ").capitalize()
			print_board()
		else:
			pass
	...
	while player2_move not in choices or player2_move in player_all_moves:
		if player2_move not in choices:
			player2_move = input(player2 + ", please make a valid move. For example: 'a1'  ").capitalize()
			print_board()
		elif player2_move in player_all_moves:
			player2_move = input(player2 + ", " + player2_move + " is already taken. Try somewhere else  ").capitalize()
			print_board()
		else:
			pass
